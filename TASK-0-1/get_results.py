...
if __name__ == "__main__":
    ...
    DATASET_PATH = os.path.join(os.path.dirname(__file__), 'A4_test_data.pt')  # Path to the dataset file
    
    model = EnergyRegressor(FEAT_DIM)
    model_path = os.path.join(os.path.dirname(__file__), 'trained_model_weights.pth')
